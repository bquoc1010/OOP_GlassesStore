...
class Product {
   ...
   public:
    ...
    Product(string productId, string name, float price, int amount, string createDate, string modifiedDate) {
    ...
    Product(string productId, string name, float price, int amount) {
        this->productId = productId;
        this->name = name;
        this->price = price;
        this->amount = amount;
