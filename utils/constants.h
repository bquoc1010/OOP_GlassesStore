...
// database
const string ORDER_FILE_NAME = "order_data.txt";
const string PRODUCT_FILE_NAME = "product_data.txt";
const string CUSTOMER_FILE_NAME = "customer_data.txt";
const string ORDER_ITEM_FILE_NAME = "order_item_data.txt";

// Id counter
const string ITEM_COUNTER_FILE = "item_counter_data.txt";
